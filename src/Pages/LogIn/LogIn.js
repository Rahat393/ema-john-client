...
const LogIn = () => {
  ...
  return (
    <section className='h-[70vh] w-full flex items-center justify-center my-10'>
    <div className='flex rounded-lg bg-white shadow-lg h-[450px] w-[700px]' data-aos="flip-right">
      <div className='lg:w-1/2 p-8'>
        ...
        <p className='mt-10'>Don't have an account? <Link to='/signUp' className='text-colorGreen'><span className='underline text-blue-600'>Register Here</span></Link></p>
      </div>
